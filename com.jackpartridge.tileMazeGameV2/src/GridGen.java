...
public class GridGen extends PApplet {
    ...
    public int sizeVar = 43; //Tiles per row ///Variable
    public int windowVar = 903; //Window size ///Variable

    public int width = windowVar;
    public int height = windowVar;
    ...
    public int rows = sizeVar;
    public int cols = sizeVar;
    public int s = (height / rows);
    public Tile[][] grid = new Tile[rows][cols];
    public Tile current = grid[24][12];
    ...
    public void draw() {
        ...
        //
        fill(24, 145, 10);
        rect((rows - 1) * s, ((rows - 1) / 2) * s, s, s);
        fill(171, 0, 0);
        rect(0, ((rows - 1) / 2) * s, s, s);
        //
    }
    ...
    public void pathAccepted(){
        while(current != grid[0][12]){
